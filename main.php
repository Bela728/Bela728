...
if(!isBanned($userId) && !isMuted($userId)){
  ...
  if($userId == $config['adminID']){
    ...
    bot('sendmessage',[
        'chat_id'=>$chat_id,
        'text'=>"<b>Hello <a href='tg://user?id=$userId'>User</a>
...
$messagesec",
    ...
    'reply_markup'=>json_encode(['inline_keyboard' => [
        [
          ['text' => "Bot Created By", 'url' => "t.me/Excuseme_Guys"]
        ],
        [
          ['text' => "Group", 'url' => "t.me/CyboChats"]
        ],
...
<b>ϟ Join <a href='t.me/CyboChats'>CyboChats</a></b>",
    'parse_mode'=>'html',
